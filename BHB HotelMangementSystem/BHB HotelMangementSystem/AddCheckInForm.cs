...
{
    public partial class AddCheckInForm : Form
    {
        private string path = "Form.txt";
        public AddCheckInForm()
        {
            InitializeComponent();
        }
        ...
        private void AddCheckInForm_Load(object sender, EventArgs e)
        {
